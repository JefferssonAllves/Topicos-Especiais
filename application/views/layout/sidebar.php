    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item">
                    <a href="<?php echo base_url() . 'localizacao' ?>"><i class="ik ik-navigation"></i><span>Localização</span></a>
                </div>
                <div class="nav-item">
                    <a href="<?php echo base_url() . 'cargos' ?>"><i class="ik ik-layers"></i><span>Cargos</span></a>
                </div>
                <div class="nav-item">
                    <a href="<?php echo base_url() . 'transportadoras ' ?>"><i class="ik ik-truck"></i><span>Transportadora</span></a>
                </div>
